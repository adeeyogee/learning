...
// Реакт выполняет ререндеринг компонента в 2х случаях: когда выполняется изменение состояния (state) компонента или его свойства (props)
...
//? В каждый компонент свойства передаются в виде объекта
